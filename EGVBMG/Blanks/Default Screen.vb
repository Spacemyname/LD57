Public Class Default_Screen
    ...
    Public Overrides Sub Draw()
        ...
        Select Case ProgressD
            ...
            Case 6
                GameObj.Textbox(New Vector2(0, Globals.BackBuffer.Height - 63), "What should" & vbCrLf & "Pokemans" & vbCrLf & "do?", Color.White, 0, 1, 0, 0, 6)
            Case 7
                GameObj.Textbox(New Vector2(0, Globals.BackBuffer.Height - 63), "What should" & vbCrLf & "Pokemans" & vbCrLf & "do?", Color.White, 0, 1, 0, 0, 7)
            Case 8
                GameObj.Textbox(New Vector2(0, Globals.BackBuffer.Height - 63), "What should" & vbCrLf & "Pokemans" & vbCrLf & "do?", Color.White, 0, 1, 0, 0, 8)
            Case 9
                GameObj.Textbox(New Vector2(0, Globals.BackBuffer.Height - 63), "What should" & vbCrLf & "Pokemans" & vbCrLf & "do?", Color.White, 0, 1, 0, 0, 9)
            Case 10
                GameObj.Textbox(New Vector2(0, Globals.BackBuffer.Height - 63), "What should" & vbCrLf & "Pokemans" & vbCrLf & "do?", Color.White, 0, 1, 0, 0, 10)
            Case 11
                GameObj.Textbox(New Vector2(0, Globals.BackBuffer.Height - 63), "What should" & vbCrLf & "Pokemans" & vbCrLf & "do?", Color.White, 0, 1, 0, 0, 11)
            Case 12
                GameObj.Textbox(New Vector2(0, Globals.BackBuffer.Height - 63), "Pokemans" & vbCrLf & "Used Attack Name!" & vbCrLf & "...", Color.White, 0, 1, 0, 0, 0)
            Case 13
